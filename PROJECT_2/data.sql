...
insert into Company(CompId, CompName, Address) values (4, 'Comp4', 'comp address4');
insert into Company(CompId, CompName, Address) values (6, 'Google', 'Menlo Park');
--Recruiter
...
insert into  Internship(StudentId, CompId, RecId, OfferYear) values (1, 1, 1,2013);
insert into  Internship(StudentId, CompId, RecId, OfferYear) values (1, 1, 1,2011);
insert into  Internship(StudentId, CompId, RecId, OfferYear) values (5, 2, 1,2011);
insert into  Internship(StudentId, CompId, RecId, OfferYear) values (5, 6, 1,2011);  
...
insert into  Internship(StudentId, CompId, RecId, OfferYear) values (2, 3, 3,1446);
--JobApplication
